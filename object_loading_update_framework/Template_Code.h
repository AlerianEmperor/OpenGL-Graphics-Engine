#ifndef _TEMPLATE_CODE_H_
#define _TEMPLATE_CODE_H_
...
void create_window(GLFWwindow*& window, string name, int width, int height, Camera& camera)
{
