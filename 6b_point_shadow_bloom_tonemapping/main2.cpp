...
int main()
{
	...
	create_window(window, "PointShadow_Bloom_ToneMapping", SCR_WIDTH, SCR_HEIGHT, camera);
	...
	Shader Cube_Shader("cube_light.vs", "cube_light.fs");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		mat4 Cube_Translate(1.0f);
		Cube_Translate = translate(Cube_Translate, lightPos - vec3(0.0f));
		Cube_Translate = scale(Cube_Translate, vec3(12, 12, 12));

		Cube_Shader.use();
		Cube_Shader.setMat4("u_projection", projection);
		Cube_Shader.setMat4("u_view", view);
		Cube_Shader.setMat4("u_model", Cube_Translate);
