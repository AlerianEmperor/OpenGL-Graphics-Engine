...
void main()
{
	...
	//vec3 light_direction = normalize(fs_in.tangent_light_pos - fs_in.tangent_frag_pos);
	//vec3 view_direction  = normalize(fs_in.tangent_view_pos - fs_in.tangent_frag_pos);
