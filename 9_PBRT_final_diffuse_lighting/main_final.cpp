...
int main()
{
	...
	Shader irradiance_shader("back_ground_convolution.vs", "back_ground_convolution.fs");
	...
	shader.setInt("irradiance_texture", 4);
	...
	GLuint irradianceMap = create_irradiance_map();
